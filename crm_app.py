...
# --- 📊 Lead Funnel Dashboard (Mock) ---
    ...
    st.info("🚧 **ฟีเจอร์นี้อยู่ระหว่างพัฒนา**")
    
    st.markdown("""
    ### 📝 คำอธิบาย
    ระบบติดตาม **Customer Journey** ตั้งแต่เป็น Lead จนกลายเป็นลูกค้า
    
    **ฟีเจอร์ที่จะมี:**
    - 📈 **Funnel Chart**: แสดง Lead → Register → Paid แต่ละขั้น
    - 📊 **Conversion Rate**: อัตราการปิดการขายในแต่ละช่วง
    - 🔍 **Filter by Channel**: ดูแยกตาม Facebook, TikTok, Line OA
    - 📅 **Time Comparison**: เปรียบเทียบผลเดือนต่อเดือน
    """)
...
# --- 🔔 Follow-up System (Mock) ---
    ...
    st.markdown("""
    ### 📝 คำอธิบาย
    ระบบแจ้งเตือนและติดตามลูกค้าเพื่อเพิ่มโอกาสการขาย
    
    **ฟีเจอร์ที่จะมี:**
    - ⏰ **Course Credit Alert**: แจ้งเตือนเมื่อคอร์สใกล้หมดอายุ (30 วัน)
    - 🔕 **Churn Alert**: ลูกค้าไม่ได้ซื้อมานานเกิน X วัน
    - ✅ **To-Do List**: รายการติดตามสำหรับ Sales แต่ละคน
    - 📞 **Follow-up History**: บันทึกการติดต่อลูกค้า
    """)
...
# --- 💰 Channel ROI Tracker (Mock) ---
    ...
    st.markdown("""
    ### 📝 คำอธิบาย
    วิเคราะห์ผลตอบแทนการลงทุน (ROI) ของแต่ละช่องทางโฆษณา
    
    **ฟีเจอร์ที่จะมี:**
    - 💵 **Ad Spend Input**: บันทึกค่าโฆษณา Facebook, TikTok, Google, Line
    - 📊 **Revenue by Channel**: ยอดขายจริงแยกตามช่องทาง
    - 📈 **ROAS Calculator**: คำนวณ Return on Ad Spend อัตโนมัติ
    - 🏆 **Channel Ranking**: จัดอันดับช่องทางที่คุ้มค่าที่สุด
    """)
...
# --- 🎯 Campaign Tracker (Mock) ---
    ...
    st.markdown("""
    ### 📝 คำอธิบาย
    ติดตามผลลัพธ์ของแต่ละแคมเปญการตลาด
    
    **ฟีเจอร์ที่จะมี:**
    - 🏷️ **สร้างแคมเปญ**: เช่น "โปร Summer Sale", "Back to School"
    - 🔗 **เชื่อมโยงกับการขาย**: ติดตามยอดที่มาจากแคมเปญ
    - 📊 **A/B Comparison**: เปรียบเทียบผลแคมเปญ A vs B
    - 📅 **Campaign Calendar**: ปฏิทินแคมเปญทั้งหมด
    """)
...
# --- 🧩 Customer Segments (RFM) (Mock) ---
    ...
    st.markdown("""
    ### 📝 คำอธิบาย
    แบ่งกลุ่มลูกค้าอัตโนมัติโดยใช้ **RFM Analysis** (Recency, Frequency, Monetary)
    
    **ฟีเจอร์ที่จะมี:**
    - 👑 **VIP Customers**: ลูกค้าที่ซื้อบ่อยและยอดสูง
    - 🔄 **Loyal Customers**: ลูกค้าประจำ
    - ⚠️ **At Risk**: ลูกค้าที่เริ่มห่างหาย
    - 🆕 **New Customers**: ลูกค้าใหม่
    - 🎯 **Targeted Promotions**: แนะนำโปรโมชั่นเหมาะกับแต่ละกลุ่ม
    """)
...
# --- 📅 Event Calendar (Mock) ---
    ...
    st.markdown("""
    ### 📝 คำอธิบาย
    ปฏิทินจัดการกิจกรรมและ Openhouse
    
    **ฟีเจอร์ที่จะมี:**
    - 📅 **Event Calendar**: ปฏิทินแสดงกิจกรรมทั้งหมด
    - ➕ **สร้าง Event**: บันทึกชื่องาน, วันที่, สถานที่
    - 👥 **Lead Tracking**: ติดตาม Lead ที่มาจากแต่ละงาน
    - 📊 **Event Performance**: วิเคราะห์ผลลัพธ์ของงานที่ผ่านมา
    """)
